...
- `npm run quality` runs generated asset drift checks, test, lint, design redline checks, build, static HTML output checks, accessibility checks, public link allowlist checks, sensitive content scanning, and audit checks.
